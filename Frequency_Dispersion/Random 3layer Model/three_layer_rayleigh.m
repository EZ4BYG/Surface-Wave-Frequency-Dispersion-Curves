...
% 模型已知参数:
% 三层模型:正常层序,密度、速度从上往下依次增大
vp = [400,650,800];  % 纵波速度
vs = [200,400,600];  % 横波速度 √
den = [2000,2600,3200];
h = [5,10,15];   % 这里我不确定,我认为第三层速度要给！否则下面的矩阵无法计算
% Vr = 200;      % 初始相速度
n = 3;  % 三种的介质
...
hold on
legend([basic,first,second,third,fourth],'基阶','一阶高阶','二阶高阶','三阶高阶','四阶高阶')
